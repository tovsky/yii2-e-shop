...
AppAsset::register($this);              // Регистрируем наш комплект стилей, скриптов
ltAppAsset::register($this);              // Регистрируем наш комплект стилей, подключаемых по условию.
?>
<?php $this->beginPage() ?>             <!-- первая метка начало страницы -->
<!DOCTYPE html>
<html lang="<?= Yii::$app->language ?>">    <!-- Задание языка автоматически. Его нужно указать в   'config/web.php'  -->
<head>
...
<body>
<?php $this->beginBody() ?>             <!-- Метка сразу после открывающего <body> -->
...
<?php $this->endPage() ?>           <!-- Метка окончания страницы  -->